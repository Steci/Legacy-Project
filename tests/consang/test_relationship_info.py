...
@pytest.fixture
def first_cousin_graph():
    return build_first_cousin_graph()


def test_relationship_between_first_cousins(first_cousin_graph):
    persons, families = first_cousin_graph
...
def test_relationship_same_person(first_cousin_graph):
    persons, families = first_cousin_graph
    info = build_relationship_info(persons, families)
